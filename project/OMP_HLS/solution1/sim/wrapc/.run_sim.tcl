...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/pradyumna/xilinx/Vitis_HLS/2023.1/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/pradyumna/xilinx/Vitis_HLS/2023.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/pradyumna/xilinx/Vitis_HLS/2023.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/pradyumna/xilinx/Vitis_HLS/2023.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /home/pradyumna/xilinx/Vitis_HLS/2023.1/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "omp_reconstruction.autotvin.dat"
	set constFileTvOut       "omp_reconstruction.autotvout.dat"
	set constFileHdlTvIn     "omp_reconstruction.autohdltvin.dat"
	set constFileHdlTvOut    "omp_reconstruction.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
