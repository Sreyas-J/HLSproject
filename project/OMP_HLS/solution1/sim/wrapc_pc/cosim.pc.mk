...
$(ObjDir)/src_test.cpp_pre.cpp.tb.o : src_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling src_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/src_omp.cpp_pre.cpp.tb.o : src_omp.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling src_omp.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
