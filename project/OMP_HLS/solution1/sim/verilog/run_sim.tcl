...
if {[file isfile omp_reconstruction.autotvin.dat]} {
	file delete -force omp_reconstruction.autotvin.dat
}

if {[file isfile omp_reconstruction.autotvout.dat]} {
	file delete -force omp_reconstruction.autotvout.dat
}
