...
`define AUTOTB_DUT      omp_reconstruction
`define AUTOTB_DUT_INST AESL_inst_omp_reconstruction
`define AUTOTB_TOP      apatb_omp_reconstruction_top
`define AUTOTB_LAT_RESULT_FILE "omp_reconstruction.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "omp_reconstruction.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_omp_reconstruction_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 11.00
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.omp_reconstruction.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.omp_reconstruction.autotvin_gmem1.dat"
`define AUTOTB_TVIN_y_out_wrapc  "../tv/rtldatafile/rtl.omp_reconstruction.autotvin_y.dat"
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.omp_reconstruction.autotvin_A.dat"
`define AUTOTB_TVIN_x_out_out_wrapc  "../tv/rtldatafile/rtl.omp_reconstruction.autotvin_x_out.dat"
`define AUTOTB_TVOUT_gmem2  "../tv/cdatafile/c.omp_reconstruction.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.omp_reconstruction.autotvout_gmem2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 30105;
parameter LENGTH_A = 1;
parameter LENGTH_gmem0 = 48;
parameter LENGTH_gmem1 = 6144;
parameter LENGTH_gmem2 = 128;
parameter LENGTH_x_out = 1;
