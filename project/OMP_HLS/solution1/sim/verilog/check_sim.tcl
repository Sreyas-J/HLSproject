...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.omp_reconstruction.autotvin_gmem0.dat"
         "c.omp_reconstruction.autotvin_gmem1.dat"
         "c.omp_reconstruction.autotvin_y.dat"
         "c.omp_reconstruction.autotvin_A.dat"
         "c.omp_reconstruction.autotvin_x_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.omp_reconstruction.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
