...
module omp_reconstruction_omp_reconstruction_Pipeline_init_x (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln203_fu_83_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln203_fu_83_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln203_fu_89_p2 = (ap_sig_allocacmp_i_3 + 8'd1);
...
assign icmp_ln203_fu_83_p2 = ((ap_sig_allocacmp_i_3 == 8'd128) ? 1'b1 : 1'b0);
...
endmodule //omp_reconstruction_omp_reconstruction_Pipeline_init_x
