set moduleName omp_reconstruction_Pipeline_init_x
set isTopModule 0
...
set C_modelName {omp_reconstruction_Pipeline_init_x}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 32 regular {axi_master 1}  }
	{ sext_ln203 int 62 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "x_out","offset": { "type": "dynamic","port_name": "x_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln203", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln203 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln203", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln203", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln203 { ap_none {  { sext_ln203 in_data 0 62 } } }
}
