...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename index_set \
    op interface \
    ports { index_set_address0 { O 3 vector } index_set_ce0 { O 1 bit } index_set_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'index_set'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename theta \
    op interface \
    ports { theta_address0 { O 3 vector } theta_ce0 { O 1 bit } theta_q0 { I 32 vector } } \
} "
} else {
