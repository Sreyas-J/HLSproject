...
using hls::sim::Byte;
extern "C" void omp_reconstruction(Byte<4>*, Byte<4>*, Byte<4>*, int, int, int);
extern "C" void apatb_omp_reconstruction_hw(volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_x_out) {
...
__xlx_A__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_A)[i]);
  ...
  int __xlx_size_param_A = 6144;
  int __xlx_offset_param_A = 0;
  int __xlx_offset_byte_param_A = 0*4;
  // Collect __xlx_x_out__tmp_vec
std::vector<Byte<4>> __xlx_x_out__tmp_vec;
for (size_t i = 0; i < 128; ++i){
__xlx_x_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_x_out)[i]);
}
  int __xlx_size_param_x_out = 128;
  int __xlx_offset_param_x_out = 0;
  int __xlx_offset_byte_param_x_out = 0*4;
  // DUT call
  omp_reconstruction(__xlx_y__tmp_vec.data(), __xlx_A__tmp_vec.data(), __xlx_x_out__tmp_vec.data(), __xlx_offset_byte_param_y, __xlx_offset_byte_param_A, __xlx_offset_byte_param_x_out);
...
// print __xlx_apatb_param_x_out
for (size_t i = 0; i < __xlx_size_param_x_out; ++i) {
((Byte<4>*)__xlx_apatb_param_x_out)[i] = __xlx_x_out__tmp_vec[__xlx_offset_param_x_out+i];
}
}
