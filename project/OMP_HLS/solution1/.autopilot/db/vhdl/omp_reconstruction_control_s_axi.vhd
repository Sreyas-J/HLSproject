...
entity omp_reconstruction_control_s_axi is
generic (
...
end entity omp_reconstruction_control_s_axi;
...
architecture behave of omp_reconstruction_control_s_axi is
    ...
    constant ADDR_X_OUT_DATA_0 : INTEGER := 16#28#;
    constant ADDR_X_OUT_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_X_OUT_CTRL   : INTEGER := 16#30#;
